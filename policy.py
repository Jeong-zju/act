...
class ACTPolicy(nn.Module):
    ...
    def __call__(self, qpos, qtor, image, actions=None, is_pad=None):
        env_state = None
        ...
        if actions is not None: # training time
            ...
            a_hat, is_pad_hat, (mu, logvar) = self.model(qpos, qtor, image, env_state, actions, is_pad)
            ...
            a_hat, _, (_, _) = self.model(qpos, qtor, image, env_state) # no action, sample from prior
            return a_hat
